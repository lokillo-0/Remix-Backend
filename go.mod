module github.com/remixfn/xenon

go 1.24.0

require github.com/oschwald/geoip2-golang/v2 v2.0.0-beta.3

require (
	github.com/PuerkitoBio/goquery v1.10.3 // indirect
	github.com/andr1ww/odin v0.0.0-20250816190212-14be466dceda // indirect
